...
fgseaRes <- fgseaMultilevel( pathways = gmt_list, stats = ranks, minSize = 15, maxSize = 500)
fgseaRes <- fgseaRes[order(padj)]
fwrite(fgseaRes,file="data/gsea_s3s4epi_h.all.tsv")
...
ggsave(p,file="figures/gsea_s3s4epi.svg")
