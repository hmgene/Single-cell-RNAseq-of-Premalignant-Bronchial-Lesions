...
p <- VlnPlot( d, features = features, group.by = "seurat_clusters", split.by = "selfrenewal",  stack = TRUE, sort = TRUE, flip = FALSE) +
...
p <- VlnPlot( d1, features = features, group.by = "seurat_clusters", split.by = "selfrenewal",  stack = TRUE, sort = TRUE, flip = FALSE) +
  ggtitle("Target Genes by Cluster (Good vs Bad Repair)")
...
p <- VlnPlot( d2, features = features, group.by = "seurat_clusters", split.by = "selfrenewal",  stack = TRUE, sort = TRUE, flip = FALSE) +
